...
export default function FAB({
	...
	return (
		<div className="fixed bottom-8 right-8 z-50 flex flex-col-reverse items-end gap-3">
			...
			<button
				onClick={onToggle}
				className={`flex h-14 w-14 items-center justify-center rounded-full bg-sky-800 text-white shadow-lg shadow-sky-900/20 hover:bg-sky-900 hover:shadow-xl hover:shadow-sky-900/30 active:scale-95 transition-all duration-200 cursor-pointer ${
